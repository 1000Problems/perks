...
export default function LoginPage() {
  return (
    <AuthShell title="Sign in to perks" subtitle="Welcome back.">
      <form
  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 360 }}>
        <Link href="/" style={{ display: "inline-flex", alignItems: "center", gap: 8, textDecoration: "none", color: "inherit", marginBottom: 28 }}>
          <div
            style={{
              width: 22,
              height: 22,
        ...
        <h1 style={{ margin: 0, fontSize: 24, letterSpacing: "-0.01em", fontWeight: 600 }}>{title}</h1>
        <p style={{ marginTop: 8, marginBottom: 22, fontSize: 14, color: "var(--ink-3)" }}>{subtitle}</p>
        {children}
      </div>
    </main>
  );
