# Build Card by Fortiva

`card_id`: build_card_fortiva
...
```json
{
  "id": "build_card_fortiva",
  "name": "Build Card by Fortiva",
  ...
  "synergies_with": [],
  "competing_with_in_wallet": ["aspire_credit_card", "reflex_mastercard"],
  "breakeven_logic_notes": "Predatory. See aspire_credit_card.md.",
  "recently_changed": false,
  "data_freshness": "2026-05-01",
  "sources": ["https://www.fortiva.com/"]
}
```
