...
```json
{
  ...
  "ongoing_perks": [
    ...
    {"name": "Worldwide Travel Accident Insurance", "value_estimate_usd": null, "category": "travel_protection", "notes": "Up to $1,000,000 accidental death & dismemberment when common-carrier fare is charged to the card.", "source": {"url": "https://www.citi.com/credit-cards/credit-card-rewards/citi-strata-premier-travel-benefits", "type": "issuer", "label": "Citi Strata Premier travel benefits", "verified_at": "2026-05-04"}},
    {"name": "Purchase Protection", "value_estimate_usd": null, "category": "shopping_protection", "notes": "Up to $10,000 per claim, $50,000 per cardholder per year for damage or theft within 90 days of purchase.", "source": {"url": "https://www.citi.com/credit-cards/credit-card-rewards/citi-strata-premier-travel-benefits", "type": "issuer", "label": "Citi Strata Premier travel benefits", "verified_at": "2026-05-04"}},
    {"name": "Extended Warranty", "value_estimate_usd": null, "category": "shopping_protection", "notes": "Adds 24 months to manufacturer warranties of 5 years or less, up to $10,000 per item. Industry-leading among $95-tier cards.", "source": {"url": "https://www.citi.com/credit-cards/credit-card-rewards/citi-strata-premier-travel-benefits", "type": "issuer", "label": "Citi Strata Premier travel benefits", "verified_at": "2026-05-04"}},
    {"name": "Peacock monthly credit", "value_estimate_usd": 36, "category": "lifestyle", "signal_id": "claims.streaming_credit", "notes": "$3/mo statement credit when you pay your Peacock subscription with the card. Mastercard World Elite benefit; refreshes the prior DoorDash DashPass slot. Activate by setting the Strata Premier as the payment method on Peacock; credit posts within a few days of the charge.", "source": {"url": "https://www.peacocktv.com/mastercard", "type": "partner", "label": "Peacock × Mastercard", "verified_at": "2026-05-04"}},
    {"name": "Lyft monthly credit", "value_estimate_usd": 60, "category": "lifestyle", "signal_id": "rideshare_user", "notes": "$5 credit each month after 3+ Lyft rides. Enrollment required at mastercard.com/lyft.", "source": {"url": "https://www.lyft.com/mastercard", "type": "partner", "label": "Lyft × Mastercard", "verified_at": "2026-05-04"}},
    {"name": "Instacart+ trial", "value_estimate_usd": 30, "category": "lifestyle", "notes": "2 months of free Instacart+ delivery + $10 off the second order each month. Mastercard World Elite benefit; locked in via Mastercard through early 2027. Activate by adding the Strata Premier to your Instacart account and visiting instacart.com/mastercard.", "source": {"url": "https://www.instacart.com/mastercard", "type": "partner", "label": "Instacart × Mastercard", "verified_at": "2026-05-04"}},
    {"name": "No foreign transaction fees", "value_estimate_usd": null, "category": "passive", "activation": "passive", "source": {"url": "https://www.citi.com/credit-cards/citi-strata-premier-credit-card", "type": "issuer", "label": "Citi Strata Premier card page", "verified_at": "2026-05-04"}},
    {"name": "Mastercard ID Theft Protection", "value_estimate_usd": null, "category": "passive", "activation": "passive", "source": {"url": "https://mastercardus.idprotectiononline.com/", "type": "network", "label": "Mastercard ID Theft Protection", "verified_at": "2026-05-04"}},
    {"name": "Citi Quick Lock", "value_estimate_usd": null, "category": "passive", "activation": "passive", "notes": "Instantly block new charges via the Citi app if the card is misplaced.", "source": {"url": "https://www.citi.com/credit-cards/credit-card-quicklock", "type": "issuer", "label": "Citi Quick Lock", "verified_at": "2026-05-04"}}
  ],
...
```json
[
  {"id":"hotel_credit_100","group":"credits","headline":"$100 free hotel — burn it before Dec 31","personalization_template":"Once a calendar year on a $500+ stay via CitiTravel.com.","value_model":{"kind":"fixed_credit","value_usd":100,"period":"calendar_year","requires_signal_id":"hotel_credit"},"question":"claimed_this_year","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Find a $500 hotel","mechanism_md":"Citi knocks $100 off any single $500+ hotel stay (excl. taxes/fees) booked through CitiTravel.com. Applied instantly at booking. Primary cardholder only — AUs share.","how_to_md":"1. Search hotels at CitiTravel.com.\n2. Filter base rate ≥ $500.\n3. Pay with the Strata Premier — $100 deducts at checkout.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":["claims.hotel_credit.portal"],"requires_signals":["claims.hotel_credit.portal"],"provided_by":"issuer"},
  {"id":"luxury_hotels_breakfast","group":"hotels","headline":"Free breakfast + $100 amenity at 4,000 luxury hotels","personalization_template":"Mastercard Luxury Hotels & Resorts portal — comp breakfast + on-property credit per stay.","value_model":{"kind":"fixed_credit","value_usd":250,"period":"per_stay","requires_signal_id":"luxury_hotel_traveler"},"question":"claimed_this_year","prerequisites":{"profile_signals":["luxury_hotel_traveler"],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Browse properties","mechanism_md":"Booking through mastercard.com/luxuryhotels grants complimentary breakfast for two, room upgrade subject to availability, and a $100 amenity per stay across 4,000+ properties.","how_to_md":"1. Sign in at mastercard.com/luxuryhotels with your Strata Premier.\n2. Book a participating property.\n3. Perks honored at check-in.","reveals_signals":["intents.aspires_premium_hotel"],"requires_signals":["intents.aspires_premium_hotel"],"provided_by":"network"},
  {"id":"trip_delay","group":"travel_services","headline":"Get $500 back when your flight delays 6+ hours","personalization_template":"Up to $500 per covered trip on Strata Premier when you're stuck 6+ hours. Two claims a year max.","value_model":{"kind":"protection_coverage","max_value_usd":500,"period":"per_trip","trigger_question":"Had a flight delayed 6+ hours this year?"},"question":"have_filed_claim","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"File a claim","mechanism_md":"Coverage applies when a covered trip (paid in part with the Strata Premier) is delayed 6+ hours. Up to $500 for meals, lodging, and incidentals. Max 2 claims per 12-month period. Underwritten by Mastercard.","how_to_md":"1. Save receipts during the delay.\n2. File at cardbenefitservices.com within 60 days.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"trip_cancel","group":"travel_services","headline":"Reimburse a canceled trip up to $5,000","personalization_template":"Up to $5k per trip / $10k per cardholder per year for nonrefundable trip costs lost to a covered cancellation.","value_model":{"kind":"protection_coverage","max_value_usd":5000,"period":"per_trip","trigger_question":"Had a trip canceled or cut short this year?"},"question":"have_filed_claim","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"File a claim","mechanism_md":"Reimburses prepaid, nonrefundable trip costs if a covered trip is cut short or canceled for a covered reason (illness, severe weather, jury duty, etc.).","how_to_md":"1. Document the cancellation reason.\n2. Submit claim via Mastercard within 20 days of the event.","reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"rental_cdw","group":"travel_services","headline":"Free rental car CDW abroad — primary coverage","personalization_template":"Decline the rental company's CDW. Charge the rental to your Strata Premier. You're covered as primary outside the US, secondary inside.","value_model":{"kind":"protection_coverage","max_value_usd":50000,"period":"per_claim","trigger_question":"Renting a car?"},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Save the steps","mechanism_md":"MasterRental coverage. Decline the rental company's CDW/LDW; charge the rental to your Strata Premier; covered for theft and collision damage.","how_to_md":"1. Reserve and pay with the Strata Premier in the renter's name.\n2. Decline the rental company's CDW/LDW.\n3. File any claim within 45 days.","reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"fx_zero","group":"travel_services","headline":"Spend abroad fee-free","personalization_template":"No foreign transaction fees on the Strata Premier — saves ~3% vs cards that charge them.","value_model":{"kind":"system_mechanic","note":"0% FX fee — passive."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"Strata Premier charges no FX fees. Other Citi no-AF cards (Double Cash, Custom Cash) charge 3% — use Strata Premier abroad to avoid the fee.","how_to_md":"Use the Strata Premier for any foreign-merchant purchase.","reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"ext_warranty","group":"shopping","headline":"Add 24 months to any warranty under 5 years","personalization_template":"Industry-leading: doubles manufacturer warranties of 5 years or less, up to $10k per item.","value_model":{"kind":"protection_coverage","max_value_usd":10000,"period":"per_claim","trigger_question":"Buying electronics or appliances?"},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"How to claim","mechanism_md":"Adds 24 months to manufacturer warranties of 5 years or less, up to $10k per item.","how_to_md":"1. Save the receipt + warranty terms.\n2. File via Mastercard once the original warranty ends and an issue arises.","reveals_signals":["behaviors.uses_extended_warranty"],"requires_signals":[],"provided_by":"issuer"},
  {"id":"purchase_protection","group":"shopping","headline":"$10,000 stolen-item coverage on every purchase","personalization_template":"Up to $10k per claim, $50k per cardholder per year. Covers damage or theft within 90 days.","value_model":{"kind":"protection_coverage","max_value_usd":10000,"period":"per_claim","trigger_question":"Had something break or get stolen recently?"},"question":"have_filed_claim","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"File a claim","mechanism_md":"Covers damage or theft of items charged to the Strata Premier within 90 days of purchase.","how_to_md":"1. Keep your receipt + original packaging if possible.\n2. File via Mastercard within the 90-day window.","reveals_signals":["behaviors.uses_purchase_protection"],"requires_signals":[],"provided_by":"issuer"},
  {"id":"instacart_plus","group":"credits","headline":"Instacart+ free for 2 months + $10/mo off","personalization_template":"2 months free Instacart+ plus $10 off your second order each month (~$30 value).","value_model":{"kind":"fixed_credit","value_usd":30,"period":"calendar_year","requires_signal_id":"instacart_user"},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Activate","mechanism_md":"Enroll your Strata Premier at instacart.com/citi.","how_to_md":"1. Sign in at instacart.com/citi.\n2. Activate the offer with your Strata Premier.","reveals_signals":[],"requires_signals":[],"provided_by":"network"},
  {"id":"peacock_credit","group":"credits","headline":"$3/mo on Peacock — $36/yr if you stream","personalization_template":"Pay your Peacock subscription with the Strata Premier and Mastercard kicks back $3/mo as a statement credit.","value_model":{"kind":"fixed_credit","value_usd":36,"period":"calendar_year","requires_signal_id":"claims.streaming_credit"},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Set as Peacock payment","mechanism_md":"Mastercard World Elite benefit, swapped in over the prior DashPass slot. The credit posts as a statement credit within a few days of each Peacock charge.","how_to_md":"1. Open the Peacock app or peacocktv.com.\n2. Set your Strata Premier as the payment method.\n3. The $3 credit auto-applies to each Peacock charge.","source_urls":["https://www.peacocktv.com/mastercard"],"reveals_signals":[],"requires_signals":[],"provided_by":"network"},
  {"id":"lyft_monthly_credit","group":"credits","headline":"$5 a month on Lyft — $60/yr if you ride","personalization_template":"After 3+ Lyft rides in a month, the 4th and beyond stack a $5 credit. Up to $60/yr.","value_model":{"kind":"fixed_credit","value_usd":60,"period":"calendar_year","requires_signal_id":"rideshare_user"},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Enroll","mechanism_md":"Enrollment required at mastercard.com/lyft. Once enrolled, take 3+ Lyft rides in a month and any further ride that month earns a $5 statement credit.","how_to_md":"1. Visit mastercard.com/lyft.\n2. Enroll your Strata Premier.\n3. Use it for Lyft rides as you would normally.","reveals_signals":[],"requires_signals":[],"provided_by":"network"},
  {"id":"earn_dining_3x","group":"cash","headline":"Stack 3x on every restaurant bill","personalization_template":"You spend ~{spend.dining}/yr on dining → about {value.dining_3x} in TY value.","value_model":{"kind":"multiplier_on_category","spend_category":"dining","pts_per_dollar":3},"question":"spending_here","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Set as default","mechanism_md":"Restaurants — dine-in, takeout, delivery — all earn 3x TY pts. Uncapped.","how_to_md":"Pay every meal with the Strata Premier.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"earn_supermarkets_3x","group":"cash","headline":"3x on groceries — uncapped, no other major card matches","personalization_template":"You spend ~{spend.groceries}/yr at supermarkets → ~{value.groceries_3x} in TY value.","value_model":{"kind":"multiplier_on_category","spend_category":"groceries","pts_per_dollar":3},"question":"spending_here","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Set as default","mechanism_md":"Most competitors cap grocery bonus spend at $6,000/yr. Strata Premier doesn't. Costco doesn't code as supermarket.","how_to_md":"Use the Strata Premier at any supermarket. Use a different card at Costco.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"earn_gas_ev_3x","group":"cash","headline":"3x at the pump (and the EV charger)","personalization_template":"Both traditional fuel and EV charging stations earn 3x TY pts.","value_model":{"kind":"multiplier_on_category","spend_category":"gas","pts_per_dollar":3},"question":"spending_here","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Set as default","mechanism_md":"Gas + EV charging both at 3x — the EV charger inclusion was added with the Strata rebrand. Uncapped.","how_to_md":"Pay at the pump or charger with the Strata Premier.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"earn_air_hotels_3x","group":"cash","headline":"3x on flights and hotels booked direct","personalization_template":"Air travel + hotels booked direct or through any travel agency earn 3x.","value_model":{"kind":"multiplier_on_category","spend_category":"airfare","pts_per_dollar":3},"question":"spending_here","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"Includes booking through any travel agency. CitiTravel.com bookings earn 10x (separate row).","how_to_md":"Book direct or through a travel agency with the Strata Premier.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"earn_citi_travel_10x","group":"cash","headline":"10x on hotels via CitiTravel.com — top rate on the card","personalization_template":"Hotels, cars, and attractions through CitiTravel.com earn 10x. Stack with the $100 hotel credit on $500+ stays.","value_model":{"kind":"multiplier_on_category","spend_category":"hotels","pts_per_dollar":10},"question":"spending_here","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Set as default","mechanism_md":"10x on hotels, rental cars, and attractions through CitiTravel.com. Stack with the $100 hotel credit when stay is $500+.","how_to_md":"Search at CitiTravel.com. Compare to direct rates first — Citi prices can occasionally be higher.","source_urls":["https://www.citi.com/credit-cards/citi-strata-premier-credit-card"],"reveals_signals":[],"requires_signals":[],"provided_by":"issuer"},
  {"id":"mc_zero_liability","group":"niche","provided_by":"network","headline":"Mastercard Zero Liability — fraud charges aren't yours","personalization_template":"Unauthorized transactions in store, online, by phone, in app, or at ATMs aren't your problem if you used reasonable care and reported loss/theft promptly.","value_model":{"kind":"system_mechanic","note":"Always-on Mastercard liability shield."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"Cardholder isn't held responsible for unauthorized transactions made in store, by phone, online, in app, or at ATMs, provided you used reasonable care and promptly reported loss/theft. Excludes commercial cards and unregistered prepaid cards.","how_to_md":"Call the number on the back of your card immediately if it's lost or stolen. Mastercard absorbs unauthorized charges that weren't your fault.","source_urls":["https://www.mastercard.com/us/en/personal/protection-and-security/zero-liability-protection.html"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_id_theft_protection","group":"niche","provided_by":"network","headline":"Free ID-theft monitoring (enrollment required)","personalization_template":"Surface, dark, and deep web monitoring + TransUnion credit alerts + a resolution specialist when something surfaces.","value_model":{"kind":"system_mechanic","note":"Free identity monitoring after enrollment."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"Identity-theft monitoring across surface/dark/deep web, single-bureau (TransUnion) credit monitoring, and access to a resolution specialist. Provided by Iris Powered by Generali. Cardholder must enroll to receive coverage.","how_to_md":"1. Visit mastercardus.idprotectiononline.com.\n2. Enroll your Strata Premier.\n3. Set up monitoring preferences.","source_urls":["https://mastercardus.idprotectiononline.com/"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_global_service","group":"travel_services","provided_by":"network","headline":"Lost card abroad? Mastercard Global Service is 24/7","personalization_template":"One number for emergency card replacement and emergency cash advance from anywhere in the world.","value_model":{"kind":"system_mechanic","note":"24/7 worldwide assistance line."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"24/7 worldwide assistance for lost/stolen card reporting, emergency card replacement, and emergency cash advance.","how_to_md":"Save the number before you travel. US/Canada toll-free: 1-800-307-7309. Outside US (collect): +1-636-722-7111.","source_urls":["https://www.mastercard.com/us/en/personal/protection-and-security.html"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_public_transit_tap_go","group":"credits","provided_by":"network","headline":"$2.50 back monthly when you tap your card on transit","personalization_template":"Tap to pay $10+ at MBTA, CTA/Pace, NJ Transit, PATH, SEPTA, WMATA, DART, or Miami-Dade in a calendar month → $2.50 credit. Up to $30/yr.","value_model":{"kind":"fixed_credit","value_usd":30,"period":"calendar_year","requires_signal_id":"claims.transit_credit"},"question":"claimed_this_year","prerequisites":{"profile_signals":["claims.transit_credit"],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Set as transit card","mechanism_md":"$2.50 statement credit when an eligible US Mastercard cardholder taps to pay $10 or more in a calendar month at participating transit systems (MBTA Boston, CTA/Pace Chicago, DART Dallas, Miami-Dade, NJ Transit, PATH, SEPTA, WMATA). Limit one credit per cardholder per calendar month.","how_to_md":"1. Use your Strata Premier's contactless tap on a participating transit system.\n2. Hit $10+ in tap purchases in the same calendar month.\n3. $2.50 credit auto-posts within 60 days.","source_urls":["https://www.mastercard.com/us/en/personal/find-a-card/card-benefits.html"],"expires_at":"2027-12-31","reveals_signals":["claims.transit_credit"],"requires_signals":[]},
  {"id":"mc_music_entertainment_presale","group":"niche","provided_by":"network","headline":"Presale tickets at top venues — your card's first 6 digits is the passcode","personalization_template":"Mastercard Music & Entertainment Access unlocks Ticketmaster/TicketWeb presales at major US venues and festivals.","value_model":{"kind":"system_mechanic","note":"Presale access — value depends on demand."},"question":"have_done_this","prerequisites":{"profile_signals":["intents.attends_concerts"],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"Exclusive access to ticket presales at top US venues and festivals. Cardholder enters the first 6 digits of an eligible Mastercard consumer credit card as the offer passcode at checkout via Ticketmaster/TicketWeb. Not available to business or commercial Mastercards.","how_to_md":"1. Browse upcoming shows on Ticketmaster or TicketWeb.\n2. At checkout, look for the Mastercard presale window.\n3. Enter the first 6 digits of your Strata Premier as the offer passcode.","source_urls":["https://www.mastercard.com/us/en/personal/find-a-card/credit-card/world-mastercard.html"],"expires_at":"2027-03-31","reveals_signals":["intents.attends_concerts"],"requires_signals":[]},
  {"id":"mc_travel_lifestyle_services","group":"travel_services","provided_by":"network","headline":"Mastercard Travel & Lifestyle — 24/7 lifestyle manager","personalization_template":"Lowest Hotel Rate Guarantee, Hotel Stay Guarantee, and access to 3,000+ luxury hotels with breakfast and an amenity credit.","value_model":{"kind":"system_mechanic","note":"World Elite travel concierge platform."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"World Elite suite operated by Ten Lifestyle Group plc. Includes Lowest Hotel Rate Guarantee, Hotel Stay Guarantee, a complimentary 24/7 Lifestyle Manager, and access to the Mastercard Luxury Hotels & Resorts portfolio (3,000+ properties) with daily breakfast for two, room upgrade, and a $50–$100 amenity credit when available.","how_to_md":"1. Sign in at travel.mastercard.com with your Strata Premier.\n2. Book through the Lifestyle Manager (chat or phone).\n3. Hotel benefits honored at check-in.","source_urls":["https://www.mastercard.us/content/dam/public/mastercardcom/na/global-site/documents/gtb/world-elite.pdf"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_concierge_service","group":"travel_services","provided_by":"network","headline":"World Elite Concierge — call 1-877-354-8330","personalization_template":"Personal concierge for travel planning, dining reservations, ticket sourcing, gift research, and pre-trip planning.","value_model":{"kind":"system_mechanic","note":"24/7 concierge phone line."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"24/7/365 personal concierge for travel planning, dining/entertainment reservations, ticket sourcing, gift research, and pre-trip planning. Reachable at 1-877-354-8330. Goods/services purchased are billed to the cardholder's World Elite Mastercard.","how_to_md":"1. Save 1-877-354-8330 in your phone.\n2. Call when you need a hard reservation, a ticket, or a gift sourced.\n3. The concierge handles booking; charges go to your card.","source_urls":["https://www.mastercard.us/content/dam/public/mastercardcom/na/global-site/documents/gtb/world-elite.pdf"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_airport_concierge","group":"travel_services","provided_by":"network","headline":"15% off airport meet & greet at 700+ airports","personalization_template":"Departure, arrival, or connecting — Mastercard knocks 15% off the meet & greet fee. You still pay the discounted total out of pocket.","value_model":{"kind":"system_mechanic","note":"15% discount on a paid service."},"question":"have_done_this","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"15% discount on Airport Meet & Greet services at 700+ airports worldwide (departure, arrival, or connecting). Cardholder pays the discounted fee out of pocket; Mastercard does not cover the base service cost.","how_to_md":"1. Book the meet & greet through your concierge or directly via the Mastercard travel portal.\n2. Pay with your Strata Premier.\n3. 15% off applies at booking.","source_urls":["https://www.mastercard.us/content/dam/public/mastercardcom/na/global-site/documents/gtb/world-elite.pdf"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_golf","group":"niche","provided_by":"network","headline":"Tee times at TPC courses + PGA TOUR experiences","personalization_template":"Mastercard Golf Concierge unlocks preferred tee times at TPC Network courses and PGA TOUR / Open Championship hospitality.","value_model":{"kind":"system_mechanic","note":"Golf concierge access."},"question":"have_done_this","prerequisites":{"profile_signals":["intents.plays_golf"],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"World Elite cardholders get a Golf Concierge Service, preferred tee times at participating TPC Network courses, PGA TOUR experiences, and access to Open Championship and AIG Women's Open hospitality offers via Priceless.","how_to_md":"1. Browse priceless.com PGA TOUR collection.\n2. Book through the Golf Concierge for TPC tee times.\n3. Pay with your Strata Premier.","source_urls":["https://www.priceless.com/celebrity/10896/pga-tour"],"reveals_signals":["intents.plays_golf"],"requires_signals":[]},
  {"id":"mc_priceless_experiences","group":"niche","provided_by":"network","headline":"Priceless — curated experiences in 45+ destinations","personalization_template":"Mastercard's curated marketplace of culinary, arts, sports, and travel experiences. Some are tier-gated to World Elite.","value_model":{"kind":"system_mechanic","note":"Curated experience marketplace."},"question":"have_done_this","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"Marketplace of curated experiences (culinary, arts, sports, travel) bookable with any Mastercard, with select experiences gated to World Elite and World Legend tiers across 45+ destinations.","how_to_md":"1. Browse priceless.com.\n2. Filter by city or category.\n3. Book and pay with your Strata Premier.","source_urls":["https://www.priceless.com/"],"reveals_signals":[],"requires_signals":[]},
  {"id":"mc_lyft_airport_10pct","group":"travel_services","provided_by":"network","headline":"10% off Lyft scheduled airport rides","personalization_template":"Use your Strata Premier (physical card — Apple Card and digital wallets excluded) on scheduled Lyft rides to/from US airports → 10% off at booking.","value_model":{"kind":"system_mechanic","note":"10% off airport scheduled rides."},"question":"set_up","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"mechanism_md":"10% off Lyft Scheduled Rides to/from qualifying US (incl. Puerto Rico) airports when paid in full with a World Elite or World Legend consumer Mastercard. Discount is reflected at booking; physical card must be linked. Apple Card and digital-wallet payments excluded.","how_to_md":"1. In Lyft, use 'Schedule a Ride' to a qualifying US airport.\n2. Pay with your Strata Premier (not via Apple Pay or other digital wallets).\n3. 10% discount shows at booking.","source_urls":["https://help.lyft.com/hc/en-us/rider/articles/360020383574-World-and-World-Elite-Mastercard-"],"expires_at":"2027-01-31","reveals_signals":[],"requires_signals":[]},
  {"id":"lost_luggage","group":"travel_services","provided_by":"issuer","headline":"Up to $3,000 if your bags are lost or damaged","personalization_template":"Charge the common-carrier fare to your Strata Premier; bags lost 10+ days or damaged in transit get reimbursed up to $3,000 per trip ($2,000 per bag for NY residents). Two claims a year max.","value_model":{"kind":"protection_coverage","max_value_usd":3000,"period":"per_trip","trigger_question":"Lost or damaged a bag on a paid trip?"},"question":"have_filed_claim","prerequisites":{"profile_signals":[],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"File a claim","mechanism_md":"Reimburses checked or carry-on luggage permanently lost (missing 10 consecutive days) or damaged on a covered trip charged to the Strata Premier. Up to $3,000 per covered trip ($2,000 per bag for NY residents); 2 claims per account per 12 consecutive months. Secondary to common carrier and other insurance. Excludes electronics, jewelry, money, and sporting equipment unless checked, plus trips under 100 miles. Underwritten by AIG / New Hampshire Insurance.","how_to_md":"1. Charge the common-carrier fare to your Strata Premier.\n2. Report the loss/damage to the carrier and get written confirmation.\n3. File at mycardbenefits.com or call Sedgwick within the documented window.","source_urls":["https://www.cardbenefits.citi.com/-/media/CPP/Files/LegalDocs/SOAPI/PID89_Strata_Premier_CRE131_GTPB_0524_tagged.ashx"],"reveals_signals":[],"requires_signals":[]}
]
```
...
```json
[
  {"id":"mc_cell_phone_protection","name":"Cell phone protection","reason":"Citi did not include cell phone protection on the Strata Premier — the issuer's Guide to Protection Benefits has no cellular wireless EOC.","evidence_url":"https://www.cardbenefits.citi.com/-/media/CPP/Files/LegalDocs/SOAPI/PID89_Strata_Premier_CRE131_GTPB_0524_tagged.ashx"},
  {"id":"mc_travel_accident_insurance","name":"Travel accident insurance","reason":"Removed when Citi relaunched the card in May 2024. Travel accident coverage is no longer in the Strata Premier Guide to Protection Benefits.","evidence_url":"https://www.cardbenefits.citi.com/-/media/CPP/Files/LegalDocs/SOAPI/PID89_Strata_Premier_CRE131_GTPB_0524_tagged.ashx"},
  {"id":"mc_baggage_delay","name":"Baggage delay reimbursement","reason":"Citi packages only Lost/Damaged Luggage on this card — a separate per-day delay benefit (common on other World Elite cards) is not included.","evidence_url":"https://www.cardbenefits.citi.com/-/media/CPP/Files/LegalDocs/SOAPI/PID89_Strata_Premier_CRE131_GTPB_0524_tagged.ashx"},
  {"id":"mc_priority_pass","name":"Priority Pass lounge access","reason":"Priority Pass is reserved for the Citi Strata Elite (World Legend tier). The Strata Premier lists no lounge benefit.","evidence_url":"https://www.citi.com/credit-cards/citi-strata-premier-credit-card"}
]
```
...
```json
[
  {"id":"hyatt_park_tokyo","group":"hotels","headline":"Sleep at Park Hyatt Tokyo for ~$700/night cheaper","personalization_template":"{when_trip:japan|Heading to Japan {trip:japan} — }30k–40k TY pts at the Park Hyatt covers nights normally costing $700+.","value_model":{"kind":"transfer_redemption","partner_program":"World of Hyatt","points_one_way":35000,"cash_equiv_usd_low":600,"cash_equiv_usd_high":900,"destination_signal":"destination_japan","surcharges_usd":0},"question":"have_done_this","prerequisites":{"profile_signals":["destination_japan"],"cards_held_any_of":[],"cards_held_all_of":[]},"action_label":"Find dates","mechanism_md":"Citi → World of Hyatt 1:1. Park Hyatt Tokyo prices at Hyatt Cat 7 (35k–45k pts/night). Pool TY points to Strata Premier first to get the 1:1 ratio.","how_to_md":"1. Find available dates on hyatt.com.\n2. Transfer Citi → Hyatt 1:1.\n3. Book on hyatt.com.","conditions_md":"The Park Hyatt Tokyo has been closed for a multi-year renovation through most of 2025–2026. Confirm reopening status before transferring points; Hyatt-cat-7 elsewhere (Andaz Tokyo, Park Hyatt Kyoto) is the alternate target if Tokyo isn't bookable.","source_urls":["https://thepointsguy.com/loyalty-programs/redeeming-citi-thankyou-points-maximum-value/"],"reveals_signals":["transfers.to_hyatt","intents.aspires_japan","intents.aspires_premium_hotel"],"requires_signals":[]},
