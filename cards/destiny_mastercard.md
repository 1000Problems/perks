...
```json
{
  "id": "destiny_mastercard",
  "name": "Destiny Mastercard",
  "issuer": "Genesis FS Card Services / First Electronic Bank",
  "network": "Mastercard",
  "card_type": "personal",
  ...
  "synergies_with": [],
  "competing_with_in_wallet": ["indigo_mastercard", "milestone_mastercard"],
  "breakeven_logic_notes": "Predatory. See aspire_credit_card.md.",
  "recently_changed": false,
  "data_freshness": "2026-05-01",
  "sources": ["https://www.destinycard.com/"]
}
```
