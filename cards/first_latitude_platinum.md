# First Latitude Platinum Mastercard Secured

`card_id`: first_latitude_platinum
...
```json
{
  "id": "first_latitude_platinum",
  "name": "First Latitude Platinum Mastercard Secured",
  "issuer": "Synovus Bank",
  "network": "Mastercard",
  "card_type": "personal",
  ...
  "issuer_rules": [],
  "best_for": ["secured_path_credit_building"],
  "synergies_with": [],
  "competing_with_in_wallet": ["discover_it_secured", "capital_one_quicksilver_secured"],
  "breakeven_logic_notes": "AF $39. No-AF Discover/Cap One secured preferred.",
  "recently_changed": false,
  "data_freshness": "2026-05-01",
  "sources": ["https://www.firstlatitudecards.com/platinum-mastercard"]
}
```
