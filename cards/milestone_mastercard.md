...
```json
{
  "id": "milestone_mastercard",
  "name": "Milestone Mastercard",
  "issuer": "Genesis FS Card Services / Concora",
  "network": "Mastercard",
  "card_type": "personal",
  ...
  "synergies_with": [],
  "competing_with_in_wallet": ["indigo_mastercard"],
  "breakeven_logic_notes": "Predatory. See aspire_credit_card.md.",
  "recently_changed": false,
  "data_freshness": "2026-05-01",
  "sources": ["https://www.milestonegoldcard.com/"]
}
```
