...
```json
{
  ...
  "best_for": ["west_elm_loyalists"],
  "synergies_with": ["williams_sonoma_key_rewards", "pottery_barn_key_rewards"],
  ...
  "data_freshness": "2026-05-01",
  "sources": ["https://www.westelm.com/customer-service/credit-card.html"]
}
```
